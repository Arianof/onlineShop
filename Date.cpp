...
{
    if (right.getYear() != getYear())
        return false;
    if (right.getMonth() != getMonth())
        return false;
    if (right.getDay() != getDay())
        return false;
...
bool Date::operator<=(Date right)
{
    ...
    if (right.getMonth() < getMonth() &&right.getYear() >= getYear())
    {
        return false;
    }
    if (right.getDay() < getDay() &&right.getMonth() >= getMonth()&&right.getYear() >= getYear())
    {
        return false;
    }
    return true;
